...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col justify-between p-4 overflow-y-auto">
      ...
      {/* Footer Controls */}
      <div className="mt-6 pt-3 border-t border-slate-200/80 dark:border-white/10 space-y-2">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center rounded-xl bg-slate-100 dark:bg-white/5 p-2 text-slate-500 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-400 border border-slate-200/80 dark:border-white/10 transition-colors"
          >
