...
export const PublicLandingPage: React.FC<PublicLandingPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/50 to-sky-50/70 dark:bg-[#050B14] text-slate-900 dark:text-[#F5F9FF] font-sans selection:bg-sky-500 selection:text-white relative overflow-hidden">
      {/* Background Ambient Lighting */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden z-0">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-sky-300/30 dark:bg-blue-600/15 rounded-full blur-[140px] -mr-48 -mt-48" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-400/20 dark:bg-emerald-500/15 rounded-full blur-[120px] -ml-24 -mb-24" />
        <div className="absolute top-1/2 left-1/3 w-[600px] h-[600px] bg-sky-200/40 dark:bg-cyan-500/10 rounded-full blur-[160px]" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Navigation Bar */}
        <header className="flex items-center justify-between pb-6 mb-8 border-b border-sky-200/60 dark:border-white/10 glass-header px-6 py-4 rounded-3xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="ml-2 text-[10px] font-bold px-2 py-0.5 rounded-full bg-sky-500/10 text-sky-700 dark:text-cyan-400 border border-sky-300/50 dark:border-white/10">
                V3.1
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-white/80 dark:bg-[#0B1626] border border-sky-200 dark:border-sky-500/30 text-slate-700 dark:text-[#F5F9FF] font-semibold text-xs hover:bg-slate-100 dark:hover:bg-[#101D30] active:scale-95 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
              title="Toggle Theme"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white/90 dark:bg-[#0B1626] hover:bg-slate-100 dark:hover:bg-[#101D30] active:scale-[0.98] active:bg-slate-200 dark:active:bg-[#152438] text-slate-800 dark:text-[#F5F9FF] border border-sky-200/80 dark:border-sky-500/30 font-bold text-xs transition-all cursor-pointer shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:ring-offset-1 dark:focus:ring-offset-[#050A14]"
            >
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6 pt-4 pb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-sky-500/10 text-sky-700 dark:text-sky-300 text-xs font-extrabold border border-sky-300/60 dark:border-sky-500/30">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <button
              onClick={() => onOpenAuth('signup')}
              className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-500 hover:to-blue-500 text-white font-bold text-sm shadow-xl shadow-sky-600/25 flex items-center justify-center gap-2 transition-all cursor-pointer"
            >
            ...
            <button
              onClick={onEnterDemo}
              className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-white/80 dark:bg-[#0B1626]/80 hover:bg-white text-slate-800 dark:text-[#F5F9FF] font-bold text-sm border border-sky-200 dark:border-sky-500/20 shadow-lg flex items-center justify-center gap-2 transition-all cursor-pointer"
            >
        ...
        <div className="mb-12 pt-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <GlassCard className="p-5 space-y-2 border-sky-200/80 dark:border-sky-500/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <GlassCard className="p-6 space-y-3">
            <div className="h-12 w-12 rounded-2xl bg-sky-500/10 text-sky-600 dark:text-sky-400 border border-sky-300/50 flex items-center justify-center">
          ...
          <GlassCard className="p-6 space-y-3">
            <div className="h-12 w-12 rounded-2xl bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-300/50 flex items-center justify-center">
          ...
          <GlassCard className="p-6 space-y-3">
            <div className="h-12 w-12 rounded-2xl bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-300/50 flex items-center justify-center">
        ...
        <GlassCard className="p-8 mb-12 relative overflow-hidden border-sky-300/60 dark:border-sky-500/30">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-3 max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-500/10 text-sky-700 dark:text-sky-300 text-[11px] font-bold border border-sky-300/50">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1 text-xs text-slate-500 dark:text-slate-400">
                <span className="flex items-center gap-1 font-semibold text-slate-700 dark:text-slate-200">
                  <Code className="h-3.5 w-3.5 text-sky-500" /> C++, Python, AI/ML, React, Supabase
                </span>
                <span>•</span>
                <span className="flex items-center gap-1 font-semibold text-slate-700 dark:text-slate-200">
                  <Award className="h-3.5 w-3.5 text-sky-500" /> Marwadi University
                </span>
              </div>
            </div>
        ...
        {/* Footer */}
        <footer className="pt-8 border-t border-sky-200/50 dark:border-white/10 text-center text-xs text-slate-500 dark:text-slate-400">
